...
### 💡 [Force Sensor LEDs](https://github.com/tuanhoang0117/force-sensor-LEDs)
Embedded systems project that reads analog force sensor data and dynamically controls LED brightness using signal processing.
- **Stack:** Python, Embedded Systems
- **Topics:** IoT, Sensors, Arduino, Signal Processing

### 📖 [Phonebook Application](https://github.com/tuanhoang0117/Phonebook-Application)
Console-based contact manager built in C++ with full CRUD operations, search functionality, and persistent file-based storage.
- **Stack:** C++
- **Topics:** Data Structures, Algorithms, File I/O
